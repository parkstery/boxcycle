...
| [260903-gient 20배 제품 채택 G-3 작업지시서](ops/gient-relay/260903-gient-20배-제품채택-G3-작업지시서.md) | **현재 작업 `GIENT-ADOPT-20X-G3`** — 2026-08-27 「자이언트 미채택」을 **20배 한정으로 뒤집는다**. 카메라 전환점 36배 아래라 공식 미영향. 400배는 미채택 유지 | 실행 대기 |
