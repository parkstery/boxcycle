...
진행 중 실행 계획: [Modelling 라이더 교체](260910-Modelling-라이더-교체-실행계획.md) — 양팔 직선화 결과 경로·전달 해시 수신, 다음 사용자 진행 요청 대기. [최신 라이더 인계 조건](260912-Modelling-최신라이더-인계조건.md) — 인계 위치·해시·승인 상태와 다음 단계. 제품 교체 미실행.
...
| [260913-도로망-재방문실험-4단계-작업지시서](ops/ride-relay/260913-도로망-재방문실험-4단계-작업지시서.md) | `RIDE-RETURN-EXPERIMENT-4` · PR #18 | **무기한 보류** |
| [260913-재방문보류-라이더GLB교체-충돌점검](archive/260913-재방문보류-라이더GLB교체-충돌점검.md) | 4단계+보류 vs GLB 교체 | HARD 충돌 없음 |
| [260913-개발팀장-착수브리핑-4단계](ops/ride-relay/260913-개발팀장-착수브리핑-4단계.md) | `260910-개발팀장` 창 | 보류로 종결 |
| [260913-재방문실험-운영-초안](ops/ride-relay/260913-재방문실험-운영-초안.md) | 모집·동행 초안 | draft · 발송 금지·보류 |
