...
진행 중 실행 계획: [Modelling 라이더 교체](260910-Modelling-라이더-교체-실행계획.md) — 외형 보존 우선 경량화 후보의 단계 0 완료, 사용자 승인 대기. [최신 라이더 인계 조건](260912-Modelling-최신라이더-인계조건.md) — 최신 후보·보존 원본 이력·승인 상태와 다음 단계. 단계 0 기록은 [외형 보존 후보](archive/260913-Modelling-라이더-교체-단계0-외형보존후보.md). 제품 교체 미실행.
