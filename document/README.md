...
| [260812-AI-오케스트레이션-Claude-인수인계](260812-AI-오케스트레이션-Claude-인수인계.md) | Cursor 보고완료 → Claude 자동 감리 1단계의 산출물·실패 원인·후속 개발 인수인계 | 검토됨 |
| [260812-AI-오케스트레이션-Claude-구축-가이드](260812-AI-오케스트레이션-Claude-구축-가이드.md) | 운영 가능한 상태 머신·runner 수명주기·복구·단계별 자동화에 대한 Claude 방향 가이드 | 검토됨 |
