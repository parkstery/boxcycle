...
| [260902-거리·방향 자동 Route 3G 병합·푸시 및 Token 온보딩 기본값 작업지시서](ops/route-relay/260902-거리방향-자동Route-3G-병합푸시-Token온보딩기본값-작업지시서.md) | **`DISTANCE-AUTO-ROUTE-MERGE-3G`** — 3F-C-R1·Token 온보딩 Guest 10/로그인 15를 `main2`에 `--no-ff` 병합·푸시 | **완료 (2026-09-02)** |
| [260902-거리·방향 자동 Route 실패 없는 도달 제안 3F-C-R1 작업지시서](ops/route-relay/260902-거리방향-자동Route-실패없는-도달제안-3F-C-R1-작업지시서.md) | **`DISTANCE-AUTO-ROUTE-REACH-OFFER-3F-C-R1`** — 도넛 폐기, `offered`/`exact`/`detoured`, 6클릭 6/6 | **main2 병합 완료 (2026-09-02)** |
