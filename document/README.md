...
| [260910-도로망-다음접속-2단계-작업지시서](ops/ride-relay/260910-도로망-다음접속-2단계-작업지시서.md) | **현재 실행 작업 `RIDE-NEXT-VISIT-2`** — 재방문 시 NextRideCard idle 카메라 프레이밍·가독성·입문 CTA 1급 제공 | PR 중 |
