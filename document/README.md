...
| [260913-도로망-재방문실험-4단계-작업지시서](ops/ride-relay/260913-도로망-재방문실험-4단계-작업지시서.md) | **현재 `RIDE-RETURN-EXPERIMENT-4`** · PR #18 검수 PASS | Chief 병합·배포 대기 |
| [260913-개발팀장-착수브리핑-4단계](ops/ride-relay/260913-개발팀장-착수브리핑-4단계.md) | `260910-개발팀장` 창 착수 | 종결(시도1 PASS) |
| [260913-재방문실험-운영-초안](ops/ride-relay/260913-재방문실험-운영-초안.md) | 모집·동행 초안(발송 금지) | draft · PR #18 |
