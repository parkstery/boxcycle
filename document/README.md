...
진행 중 실행 계획: [Modelling 라이더 교체](260910-Modelling-라이더-교체-실행계획.md) — natural_joint_skin 인계 기록 갱신, 목둘레 완료 미확인·외형 승인·앱 운동 검증 미완료. [최신 라이더 인계 조건](260912-Modelling-최신라이더-인계조건.md) — 파일·해시·연속 피부 구조와 다음 단계. 이전 단계 0은 [외형 보존 후보 이력](archive/260913-Modelling-라이더-교체-단계0-외형보존후보.md)으로 보존. 제품 교체 미실행.
