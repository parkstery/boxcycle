...
| # | 질문 | 결정 시기 |
|---|------|-----------|
| Q1 | ~~외부 노출 명칭을 BOXCYCLE 유지할지 Ride The World로 전환할지~~ | **결정(2026-07-03)** — UI 노출명 **RTW(Ride The World)** 전환 완료(2026-06-29 UI 5곳 반영, [진행 검토 §3.1](260702-프로젝트-진행-종합-검토-보고서.md)). 코드·리포·Firebase projectId는 `boxcycle` 유지. 앱스토어·도메인 표기만 출시 시점 확정 |
