...
const repoFiles = [
  ...
  'apps/web/src/lib/riderPrototype/riderIk.mjs', 'apps/web/src/lib/riderGlbPedalPose.pose.mjs',
  'apps/web/src/lib/riderGlbPedalPose.ts', 'apps/web/src/lib/riderPedalMotion.ts',
  'apps/web/src/lib/rideCameraFraming.ts', 'apps/web/src/lib/mapGlobeView.ts',
