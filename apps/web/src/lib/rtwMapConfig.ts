 ...
 *
 * 그 대역 안에서 다시 마젠타(330°)가 아니라 퍼플(280°)을 쓰는 이유: 이미 내 것인 도로
 * **위를 다시 달릴 때** 빨간 루트(0°)와 나란히 놓이는데, 마젠타는 빨강과 30° 이웃이라
 * 한 덩어리로 읽혔다. 퍼플은 빨강에서 80° 떨어져 확실히 갈리면서도 같은 보라 계열이라
 * 「내 것」의 정체성은 유지된다.
 *
 ...
 * 내 도로망(과거 누적) — 퍼플(280°).
 * 대안(이 상수 한 줄만 고치면 된다):
 *   `#C026D3`(292°) 마젠타에 더 가깝게 · `#8B5CF6`(262°) 빨강에서 더 멀게
 */
export const RTW_TRACE_OWNED_COLOR = "#A855F7";
