 ...
 *
 *   npm run admin:seed-route-activity-heat -- --publicationId=basic-mountain-0_5km
 *   npm run admin:seed-route-activity-heat -- --publicationId=basic-mountain-0_5km --clear
 *
...
async function main(): Promise<void> {
  ...
  if (!publicationId) {
    console.error("필수: --publicationId=<id> (예: basic-mountain-0_5km)");
    process.exit(1);
  }
